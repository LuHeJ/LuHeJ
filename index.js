...
/**
        ...
        const GalleryPanel = {
          name: 'GalleryPanel',
          template: '<div class="gallery-panel"><div class="vue-card panel-card" style="--i:0"><div class="vue-card-title">渐变边框旋转</div><div class="gallery-demo-border">HOVER ME</div><div class="vue-card-desc" style="margin-top:10px">纯 CSS @keyframes 实现边框渐变色旋转，hover 触发。</div></div><div class="vue-card panel-card" style="--i:1"><div class="vue-card-title">毛玻璃深度对比</div><div style="display:flex;gap:12px"><div class="glass-demo" style="backdrop-filter:blur(4px)"><span>4px</span></div><div class="glass-demo" style="backdrop-filter:blur(12px)"><span>12px</span></div><div class="glass-demo" style="backdrop-filter:blur(24px)"><span>24px</span></div></div><div class="vue-card-desc" style="margin-top:10px">backdrop-filter blur 值越大越朦胧，对比不同深度的毛玻璃效果。</div></div><div class="vue-card panel-card" style="--i:2"><div class="vue-card-title">发光按钮</div><div style="display:flex;gap:12px;flex-wrap:wrap"><button class="glow-btn glow-red">红色光</button><button class="glow-btn glow-white">白色光</button><button class="glow-btn glow-pulse">脉冲</button></div><div class="vue-card-desc" style="margin-top:10px">box-shadow 发光 + @keyframes pulse 呼吸，悬停增强。</div></div><div class="vue-card panel-card" style="--i:3"><div class="vue-card-title">故障文字效果</div><div class="glitch-text" data-text="GLITCH EFFECT">GLITCH EFFECT</div><div class="vue-card-desc" style="margin-top:10px">::before / ::after 伪元素错位叠加，clip-path 裁剪实现 RGB 分离。</div></div></div>'
        };
        ...
        if (typeof Vue !== 'undefined') {
                ...
                data() {
                    return {
                        ...
                        tabs: [
                            ...
                            { id: 2, name: '技能领域' },
                            { id: 3, name: '联系方式' },
                            { id: 4, name: '个人简历' }, { id: 5, name: '灵感墙' }, { id: 6, name: '工具箱' }, { id: 7, name: '画廊' },
                        ],
                    };
                },
                computed: {
            ...
            if (typeof GalleryPanel !== 'undefined') app.component('gallery-panel', GalleryPanel);
