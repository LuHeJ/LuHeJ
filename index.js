...
/**
        ...
        const InspirePanel = {
          name: 'InspirePanel',
          template: '<div class="inspire-panel"><div class="vue-card panel-card float-card" style="--i:0;--float-duration:4s;--float-delay:0s"><div class="inspire-quote">&quot;好的设计是尽可能少的设计。&quot;</div><div class="inspire-author">— Dieter Rams</div></div><div class="vue-card panel-card float-card" style="--i:1;--float-duration:4.5s;--float-delay:0.3s"><div class="inspire-quote">&quot;代码是写给人看的，只是顺便让机器执行。&quot;</div><div class="inspire-author">— Harold Abelson</div></div><div class="vue-card panel-card float-card" style="--i:2;--float-duration:5s;--float-delay:0.6s"><div class="inspire-quote">&quot;简单是复杂的终极形式。&quot;</div><div class="inspire-author">— Leonardo da Vinci</div></div><div class="vue-card panel-card float-card" style="--i:3;--float-duration:4.2s;--float-delay:0.9s"><div class="inspire-quote">&quot;Stay hungry, stay foolish.&quot;</div><div class="inspire-author">— Steve Jobs</div></div><div class="vue-card panel-card float-card" style="--i:4;--float-duration:3.8s;--float-delay:0.2s"><div class="inspire-quote">&quot;世上本没有路，走的人多了，也便成了路。&quot;</div><div class="inspire-author">— 鲁迅</div></div><div class="vue-card panel-card float-card" style="--i:5;--float-duration:4.7s;--float-delay:0.5s"><div class="inspire-quote">&quot;The best way to predict the future is to invent it.&quot;</div><div class="inspire-author">— Alan Kay</div></div><div class="vue-card panel-card float-card" style="--i:6;--float-duration:5.2s;--float-delay:0.8s"><div class="inspire-quote">&quot;创造性的行为，源自于对常识的怀疑。&quot;</div><div class="inspire-author">— 宫本茂</div></div><div class="vue-card panel-card float-card" style="--i:7;--float-duration:4.0s;--float-delay:1.1s"><div class="inspire-quote">&quot;Any fool can write code that a computer can understand.&quot;</div><div class="inspire-author">— Martin Fowler</div></div></div>'
        };

        // ===== 新面板：工具箱 =====
        const ToolPanel = {
          name: 'ToolPanel',
          template: '<div class="tool-panel"><div class="vue-card panel-card tilt-card tool-card" style="--i:0"><div class="tool-icon">🧠</div><div class="vue-card-title">IntelliJ IDEA</div><div class="vue-card-desc">主力 IDE，智能代码补全与重构，Java/前端/全栈一站式开发。</div></div><div class="vue-card panel-card tilt-card tool-card" style="--i:1"><div class="tool-icon">🖥️</div><div class="vue-card-title">VS Code</div><div class="vue-card-desc">轻量编辑器，插件生态丰富，前端快速迭代首选。</div></div><div class="vue-card panel-card tilt-card tool-card" style="--i:2"><div class="tool-icon">🎨</div><div class="vue-card-title">Figma</div><div class="vue-card-desc">浏览器端协作设计，实时多人编辑，设计系统与原型交付。</div></div><div class="vue-card panel-card tilt-card tool-card" style="--i:3"><div class="tool-icon">🐳</div><div class="vue-card-title">Docker</div><div class="vue-card-desc">容器化平台，环境隔离，一次构建到处运行。</div></div><div class="vue-card panel-card tilt-card tool-card" style="--i:4"><div class="tool-icon">⚡</div><div class="vue-card-title">Vite</div><div class="vue-card-desc">新一代构建工具，ESM 原生驱动，毫秒级 HMR。</div></div><div class="vue-card panel-card tilt-card tool-card" style="--i:5"><div class="tool-icon">📦</div><div class="vue-card-title">Git</div><div class="vue-card-desc">分布式版本控制，分支策略，团队协作基石。</div></div><div class="vue-card panel-card tilt-card tool-card" style="--i:6"><div class="tool-icon">🤖</div><div class="vue-card-title">Claude</div><div class="vue-card-desc">AI 编程助手，代码生成与审查，加速开发迭代。</div></div><div class="vue-card panel-card tilt-card tool-card" style="--i:7"><div class="tool-icon">📮</div><div class="vue-card-title">Postman</div><div class="vue-card-desc">API 调试与测试，请求集合管理，团队协作。</div></div><div class="vue-card panel-card tilt-card tool-card" style="--i:8"><div class="tool-icon">🔍</div><div class="vue-card-title">Chrome DevTools</div><div class="vue-card-desc">浏览器开发者工具，性能分析，DOM 调试，网络监控。</div></div><div class="vue-card panel-card tilt-card tool-card" style="--i:9"><div class="tool-icon">💻</div><div class="vue-card-title">Terminal</div><div class="vue-card-desc">命令行终端，Shell 脚本，自动化任务，服务器管理。</div></div><div class="vue-card panel-card tilt-card tool-card" style="--i:10"><div class="tool-icon">🖼️</div><div class="vue-card-title">Photoshop</div><div class="vue-card-desc">图像编辑与设计，位图处理，UI 素材制作。</div></div><div class="vue-card panel-card tilt-card tool-card" style="--i:11"><div class="tool-icon">📝</div><div class="vue-card-title">Notion</div><div class="vue-card-desc">全功能笔记与知识库，项目管理，文档协作。</div></div></div>'
        };

        // ===== 新面板：技术百科 =====
        const WikiPanel = {
          name: 'WikiPanel',
          template: '<div class="wiki-panel"><div class="vue-card panel-card" style="--i:0"><div class="vue-card-title">RESTful API 设计原则</div><div class="vue-card-desc">REST (Representational State Transfer) 是面向资源架构的 API 设计风格。核心原则：统一接口、无状态、客户端-服务端分离、资源可缓存、分层系统。URL 应使用名词复数形式，HTTP 方法（GET/POST/PUT/DELETE）对应 CRUD 操作，状态码传达结果语义。</div><div class="vue-tag-row"><span class="vue-tag">API</span><span class="vue-tag">REST</span><span class="vue-tag">HTTP</span><span class="vue-tag">后端</span></div></div><div class="vue-card panel-card" style="--i:1"><div class="vue-card-title">Git 分支策略</div><div class="vue-card-desc">Git Flow：main/master（生产）、develop（开发）、feature/*（功能分支）、release/*（发布准备）、hotfix/*（紧急修复）。日常开发在 feature 分支，完成后合并到 develop，发布时创建 release 分支，确认后合并到 main 并打 tag。</div><div class="vue-tag-row"><span class="vue-tag">Git</span><span class="vue-tag">版本控制</span><span class="vue-tag">协作</span></div></div><div class="vue-card panel-card" style="--i:2"><div class="vue-card-title">CSS Grid vs Flexbox</div><div class="vue-card-desc">Flexbox 适合一维布局（行或列），内容尺寸决定布局。Grid 适合二维布局（行和列同时），由容器定义网格结构。简单场景用 Flex（导航栏、卡片排列），复杂页面用 Grid（整体布局、仪表盘）。两者可以嵌套使用。</div><div class="vue-tag-row"><span class="vue-tag">CSS</span><span class="vue-tag">布局</span><span class="vue-tag">前端</span></div></div><div class="vue-card panel-card" style="--i:3"><div class="vue-card-title">HTTPS 与 TLS 握手</div><div class="vue-card-desc">TLS 握手过程：客户端发送支持的加密套件 → 服务端返回证书和公钥 → 客户端验证证书 → 双方协商对称密钥 → 加密通信开始。HTTPS = HTTP over TLS，保证数据在传输过程中的机密性和完整性。</div><div class="vue-tag-row"><span class="vue-tag">网络</span><span class="vue-tag">安全</span><span class="vue-tag">HTTPS</span></div></div><div class="vue-card panel-card" style="--i:4"><div class="vue-card-title">JavaScript 事件循环</div><div class="vue-card-desc">JS 是单线程语言，通过事件循环实现异步。调用栈执行同步代码，Web APIs 处理异步任务（setTimeout/fetch），任务完成后回调进入任务队列（宏任务/微任务）。微任务（Promise.then）优先于宏任务（setTimeout）执行。</div><div class="vue-tag-row"><span class="vue-tag">JavaScript</span><span class="vue-tag">异步</span><span class="vue-tag">事件循环</span></div></div><div class="vue-card panel-card" style="--i:5"><div class="vue-card-title">Docker 核心概念</div><div class="vue-card-desc">镜像（Image）：只读模板，包含运行环境和代码。容器（Container）：镜像的运行实例，轻量隔离。Dockerfile：构建镜像的指令文件。Docker Compose：多容器应用编排。卷（Volume）：持久化数据存储。网络：容器间通信。</div><div class="vue-tag-row"><span class="vue-tag">Docker</span><span class="vue-tag">容器</span><span class="vue-tag">DevOps</span></div></div></div>'
        };
        ...
        const NaviPanel = {
          name: 'NaviPanel',
          template: '<div class="navi-panel"><div class="vue-card panel-card" style="--i:0"><div class="vue-card-title">技术文档</div><div class="navi-links"><a href="https://developer.mozilla.org" target="_blank" class="navi-link">MDN Web Docs</a><a href="https://devdocs.io" target="_blank" class="navi-link">DevDocs 聚合</a><a href="https://cn.vuejs.org" target="_blank" class="navi-link">Vue 3 中文</a><a href="https://react.dev" target="_blank" class="navi-link">React 官方</a><a href="https://tailwindcss.com" target="_blank" class="navi-link">Tailwind CSS</a><a href="https://nodejs.org/docs" target="_blank" class="navi-link">Node.js 文档</a></div></div><div class="vue-card panel-card" style="--i:1"><div class="vue-card-title">在线工具</div><div class="navi-links"><a href="https://codepen.io" target="_blank" class="navi-link">CodePen</a><a href="https://jsonformatter.org" target="_blank" class="navi-link">JSON 格式化</a><a href="https://regex101.com" target="_blank" class="navi-link">Regex 测试</a><a href="https://caniuse.com" target="_blank" class="navi-link">Can I Use</a><a href="https://www.jsv9000.app" target="_blank" class="navi-link">JS 可视化</a><a href="https://transform.tools" target="_blank" class="navi-link">代码转换</a></div></div><div class="vue-card panel-card" style="--i:2"><div class="vue-card-title">图标与素材</div><div class="navi-links"><a href="https://lucide.dev" target="_blank" class="navi-link">Lucide Icons</a><a href="https://fontawesome.com" target="_blank" class="navi-link">Font Awesome</a><a href="https://unsplash.com" target="_blank" class="navi-link">Unsplash 图片</a><a href="https://www.flaticon.com" target="_blank" class="navi-link">Flaticon</a><a href="https://coolors.co" target="_blank" class="navi-link">Coolors 配色</a><a href="https://colorhunt.co" target="_blank" class="navi-link">ColorHunt</a></div></div><div class="vue-card panel-card" style="--i:3"><div class="vue-card-title">社区与学习</div><div class="navi-links"><a href="https://github.com" target="_blank" class="navi-link">GitHub</a><a href="https://stackoverflow.com" target="_blank" class="navi-link">Stack Overflow</a><a href="https://juejin.cn" target="_blank" class="navi-link">掘金社区</a><a href="https://www.freecodecamp.org" target="_blank" class="navi-link">freeCodeCamp</a><a href="https://leetcode.cn" target="_blank" class="navi-link">LeetCode 刷题</a><a href="https://www.runoob.com" target="_blank" class="navi-link">菜鸟教程</a></div></div><div class="vue-card panel-card" style="--i:4"><div class="vue-card-title">部署与云服务</div><div class="navi-links"><a href="https://vercel.com" target="_blank" class="navi-link">Vercel</a><a href="https://pages.github.com" target="_blank" class="navi-link">GitHub Pages</a><a href="https://www.netlify.com" target="_blank" class="navi-link">Netlify</a><a href="https://hub.docker.com" target="_blank" class="navi-link">Docker Hub</a><a href="https://www.npmjs.com" target="_blank" class="navi-link">npm Registry</a><a href="https://cdnjs.com" target="_blank" class="navi-link">cdnjs</a></div></div><div class="vue-card panel-card" style="--i:5"><div class="vue-card-title">AI 工具</div><div class="navi-links"><a href="https://claude.ai" target="_blank" class="navi-link">Claude AI</a><a href="https://chat.openai.com" target="_blank" class="navi-link">ChatGPT</a><a href="https://github.com/features/copilot" target="_blank" class="navi-link">Copilot</a><a href="https://v0.dev" target="_blank" class="navi-link">v0 生成 UI</a><a href="https://bolt.new" target="_blank" class="navi-link">Bolt 快速构建</a><a href="https://huggingface.co" target="_blank" class="navi-link">Hugging Face</a></div></div></div>'
        };
        ...
        if (typeof Vue !== 'undefined') {
                ...
                data() {
                    return {
                        ...
                        tabs: [
                            ...
                            { id: 2, name: '技能领域' },
                            { id: 3, name: '联系方式' },
                            { id: 4, name: '个人简历' }, { id: 5, name: '灵感墙' }, { id: 6, name: '工具箱' }, { id: 7, name: '技术百科' }, { id: 8, name: 'Code Lab' }, { id: 9, name: '编程导航' },
                        ],
                    };
                },
                computed: {
            ...
            if (typeof NaviPanel     !== 'undefined') app.component('navi-panel',     NaviPanel);
