                    ...
                    <div class="vue-content-area">
                        ...
                        <div class="vue-content-scroll">
                            <about-panel v-if="currentTab === 1" />
                                ...
                                <navi-panel v-else-if="currentTab === 9" />
                        </div>
                    </div>
                </div>
            </div>
